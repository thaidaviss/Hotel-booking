...
function SliderRoomDetail(props) {
  ...
  console.log(
    "🚀 ~ file: index.jsx ~ line 60 ~ SliderRoomDetail ~ customSlider.current.slideIndex()",
    customSlider.current
  );
    ...
    <div className="slider-show">
      ...
      <div style={{ display: "none" }}>
        ...
        >
          {imgList.map((img, index) => (
            <div
              className="slider-show__image"
              key={`slider-show__image-${index}`}
            >
              <Image src={img}></Image>
            </div>
          ))}
      ...
      <div className="slider-show__thumb">
        {imgList.map((img, index) => (
          <div
            className={
              indexSlider === index
                ? "slider-show__thumb-item slider-show__thumb-active"
                : "slider-show__thumb-item"
            }
            key={`slider-show__img-${index}`}
